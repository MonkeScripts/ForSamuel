...
from bluerov_sim.torpedo.move_and_shoot_seq import (
    create_firing_root,
    create_move_and_shoot_generator,
)
from bluerov_sim.torpedo.point_correspondences_check import (
    create_point_correspondences_check_root,
)

# scripts/goto.py and arm_and_set_mode.py install to lib/bluerov_sim/ via
# ament_cmake `install(PROGRAMS …)`, not into this Python package. Same idiom
# as bluerov_sim/bins/bins.py and bluerov_sim/shared_trees/search.py.
...
def create_torpedo_root(
    ...
    # root in bluerov_sim/bins/bins.py so the torpedo mission doesn't rely
